...
public class RabbitMQConfig {
    ...
    public Queue initQueue(){
        return new Queue(RabbitMQConstant.CREATEHTML_BYID_QUEUE, true, false, false);
    }
    ...
    public Binding initBinding(TopicExchange initTopicExchange,Queue initQueue){
        return BindingBuilder.bind(initQueue).to(initTopicExchange).with("createHtml.byId");
    }
